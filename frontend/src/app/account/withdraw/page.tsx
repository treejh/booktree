...
export default function WithdrawalPage() {
    ...
    const handleDeleteAccount = async () => {
        try {
            ...
            router.push('/account/login') // 탈퇴 후 로그인 페이지로 이동
        } catch (error) {
                            ...
                            <div>
                                ...
                                {!provider && (
                                    <div className={styles.passwordContainer}>
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => handleAction(handlePasswordAuth)}
                                ...
                                {provider === 'KAKAO' && (
                                    <button
                                        ...
                                        onClick={() => handleAction(() => handleSocialAuth('kakao'))}
                                    >
                                ...
                                {provider === 'GITHUB' && (
                                    <button
                                        ...
                                        onClick={() => handleAction(() => handleSocialAuth('github'))}
                                    >
                                        <svg viewBox="0 0 24 24" className="w-5 h-5 mr-2 fill-current">
